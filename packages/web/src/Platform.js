...
import {IDBStorageFactory, SessionInfoStorage, OlmWorker} from "hydrogen-matrix";
import {IDBLogger, ConsoleLogger, Disposables} from "hydrogen-common";
...
export class Platform {
    constructor(container, config, cryptoExtras = null, options = null) {
        ...
        this.storageFactory = new IDBStorageFactory(this._serviceWorkerHandler);
